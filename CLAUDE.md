...
Yol haritası, mimari ve kararlar: `docs/PLAN.md` (Faz 0–4 tamam: iskelet, referans madenciliği, notch motoru, modül sistemi, medya modülü, Claude usage modülü; sıradaki: Faz 5 ayarlar & cila — başlamadan `docs/PLAN.md` §15 kararlarını ve `docs/harvest/README.md` "Öne çıkan bulgular" bölümünü oku).
