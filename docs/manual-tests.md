...
4. **Bugünün blokları (halkaların altı):** ccusage'ın bugünkü 5 saatlik blokları, token'a göre ölçekli çubuklar, altında başlangıç saatleri; aktif blok turuncu ve çalışırken parlar. `ccusage claude blocks --json --since <bugün> --offline` ile aynı bloklar.
