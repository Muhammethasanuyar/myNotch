...
- Compact kanat içeriği (kapak, ölçer, işaret) boyutunu `@Environment(\.wingContentSize)` ile alır (`Core/Window/WingContentSize.swift`); motor compact'ta 20, popup'ta 28 pt verir. Kanat görünümlerine sabit ölçü yazma.
